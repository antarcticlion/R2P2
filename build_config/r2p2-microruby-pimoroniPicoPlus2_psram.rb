MRuby::CrossBuild.new("r2p2-microruby-pimoroniPicoPlus2_psram") do |conf| # %%%%
  ...
  #
  # Adding FLASH_XIP_QSPI_SIZE_MB allows you to change the size of the
  # flash memory.
  # The possible numbers are 4, 8, and 16.
  # If undefined, it will be 2MiB.
  conf.cc.defines << "FLASH_XIP_QSPI_SIZE_MB=16"
  conf.cc.defines << "RP2350_WITH_PSRAM=1"
  conf.cc.defines << "RP2350_PSRAM_CS=47"
  #
  #
